...
$_LANG['cartdomainshashosting'] = "Hosting abinato";
...
$_LANG['domainreserved2'] = "è disponibile ma, riservato.";
...
$_LANG['imagecheck'] = "Ti preghiamo di inserire il codice di sicurezza mostrato nell'immagine - questa operazione è richiesta per prevenire invii automatizzati";
...
$_LANG['supportticketspagetitle'] = "Ticket di Supporto";
...
$_LANG['supportticketclosedmsg'] = "Questo ticket è chiuso.  Devi rispondere allo stesso per riaprirlo.";
...
$_LANG['googleRecaptchaIncorrect'] = "Risolvi il capcha per proseguire.";
...
$_LANG['feedbacksupplyrating'] = "Si prega di fornire almeno una valutazione per :staffname (commenti facoltativi)";
...
$_LANG['maxmind_checkconfiguration'] = "Si è verificato un errore con il controllo antifrode. Si prega di contattare l'assistenza.";
$_LANG['maxmind_addressinvalid'] = "Il tuo indirizzo non è riconosciuto. Si prega di controllare e reinserire.";
$_LANG['maxmind_invalidip'] = "Indirizzo IP non valido o indirizzo locale. Si prega di contattare l'assistenza.";

$_LANG['ssounabletologin'] = "Impossibile accedere automaticamente. Si prega di contattare l'assistenza.";
$_LANG['ssofatalerror'] = "Si è verificato un errore irreversibile. Si prega di contattare l'assistenza.";
...
$_LANG['sidebars']['viewAccount']['contacts/subAccounts'] = "Contatti/Sub-Account";
...
$_LANG['aboutsecurityquestions'] = "Perche le domande di sicurezza?";
...
$_LANG['notifications'] = "Notificche";
...
$_LANG['makepayment'] = "Effetua pagamento";
$_LANG['getsupport'] = "Richiedi supporto";

$_LANG['news'] = "Novità";
$_LANG['allthelatest'] = "Le ultimo da";
$_LANG['readmore'] = "Di più";
$_LANG['noannouncements'] = "Non ci sono annunci da mostrare";

$_LANG['kbsearchexplain'] = "Hai una domanda? Inizia la tua ricerca qui.";
$_LANG['readyforquestions'] = "Siamo pronti e in attesa di vostre domande";

$_LANG['restrictedpage'] = "Questa pagina è limitata";
...
$_LANG['unabletolookup'] = "Spiacente, impossibile cercare il termine inserito";
...
$_LANG['domainsgotocheckout'] = "Vai alla cassa";
$_LANG['domainssearchresults'] = "Risultati della ricerca";
$_LANG['domainssuggestions'] = "Suggerimenti";
$_LANG['domainsothersuggestions'] = "Potresti anche essere interessato ai seguenti nomi alternativi";
...
$_LANG['tldpricing'] = "Prezzi TLD";
$_LANG['alltldpricing'] = "Tutti i prezzi TLD";
...
$_LANG['sslnoconfigurationpossible'] = "La configurazione è già stata completata! Si prega di contattare l'assistenza in caso di problemi.";
...
$_LANG['adminmasqueradingasclient'] = "Attualmente sei mascherato come client.";
$_LANG['logoutandreturntoadminarea'] = "Clicca qui per uscire e tornare all'Area Amministratore";

$_LANG['supportAndUpdatesExpired'] = "Supporto e aggiornamenti scaduti.";
$_LANG['supportAndUpdatesExpiredLicense'] = "Il periodo di supporto e aggiornamenti per questa licenza è scaduto";
$_LANG['supportAndUpdatesRenewalRequired'] = "L'accesso a Supporto & Aggiornamenti deve essere rinnovato prima di poter accedere a questo download.";
$_LANG['supportAndUpdatesClickHereToRenew'] = "Clicca qui per rinnovare";

$_LANG['pwresetemailneeded'] = "Hai dimenticato la tua password? Inserisci il tuo indirizzo email qui sotto per iniziare il processo di ripristino.";

$_LANG['quotestageexpired'] = "Scaduto";
...
$_LANG['directDebitPleaseSubmit'] = "Si prega di inviare i dettagli del conto bancario qui sotto per pagare tramite addebito diretto.";
...
$_LANG['quoteacceptagreetos'] = "Per accettare il preventivo, si prega di confermare l'accettazione dei nostri termini di servizio.";
$_LANG['quoteacceptcontractwarning'] = "Si prega di essere consapevole del fatto che accettare un preventivo è considerato come stipulare un contratto e non sarà possibile annullare una volta accettato.";
...
$_LANG['clientAlerts']['invoicesUnpaid'] = "Hai :numberOfInvoices fatture non pagate. Pagale al più presto per la tua tranquillità";
...
$_LANG['clientHomePanels']['unpaidInvoicesMsg'] = "Hai :numberOfInvoices fatture non pagate per un importo totale di :balanceDue. Pagale al più presto per la tua tranquillità.";
$_LANG['clientHomePanels']['overdueInvoices'] = "Fatture scadute";
$_LANG['clientHomePanels']['overdueInvoicesMsg'] = "Hai :numberOfInvoices fatture scadute per un importo totale di :balanceDue. Pagale per evitare interruzioni del servizio.";
...
$_LANG['clientHomePanels']['affiliateSummary'] = "Il tuo attuale saldo delle commissioni è :commissionBalance. Hai bisogno solamente di altri :amountUntilWithdrawalLevel prima di poter riscuodere.";
$_LANG['clientHomePanels']['affiliateSummaryWithdrawalReady'] = "Il tuo attuale saldo delle commissioni è :commissionBalance. Ora puoi riscuodere i tuoi guadagni.";
...
$_LANG['changeDomainNS'] = "Cambia i nameserver a qualli punta il tuo dominio";
...
$_LANG['clientHomeSearchKb'] = "Inserisci una domanda qui per cercare nella nostra knowledgebase le risposte ...";
...
$_LANG['submitpayment'] = "Effetua pagamento";

$_LANG['domaincheckeravailable'] = "Disponibile";
$_LANG['domaincheckertransferable'] = "Disponibile per trasferimento";
...
$_LANG['domaincheckerunabletooffertld'] = "Purtroppo non possiamo registrare questo TLD in questo momento";
...
$_LANG['domainchecker']['suggestiontakenmsg'] = "Sfortunatamente il dominio selezionato non è disponibile. Questo a volte può verificarsi se il dominio è stato registrato di recente. Per favore torna indietro e scegli un altro dominio.";
...
$_LANG['domainchecker']['alreadyincartmsg'] = "Questo dominio è già nel tuo carrello. Procedi alla cassa per completare l'acquisto.";
$_LANG['domainchecker']['alreadyincartcheckoutnow'] = "Acquista ora";

$_LANG['genericerror']['title'] = "Oops! Qualcosa è andato storto!";
$_LANG['genericerror']['msg'] = "Si prega di riprovare e se il problema persiste, si prega di contattare il nostro team di supporto.";
...
$_LANG['cPanel']['bandwidthUsage'] = "Utilizzo banda";
$_LANG['cPanel']['usageStatsBwLimitNear'] = "Ti stai avvicinando al limite della tua larghezza di banda.";
...
$_LANG['liveHelp']['chatNow'] = "Chata ora";

$_LANG['quotes'] = "Preventivi";

$_LANG['productMustBeActiveForModuleCmds'] = "Il prodotto deve essere attivo per eseguire questa azione";
$_LANG['domainCannotBeManagedUnlessActive'] = "Questo dominio attualmente non è attivo. I domini non possono essere gestiti se non sono attivi.";
...
$_LANG['clientAreaProductAddonsAvailable'] = "I componenti aggiuntivi sono disponibili per il tuo prodotto/servizio. <a href=\"cart.php?gid=addons\">Clicca qui per vedere &amp; ordine &raquo;</a>";
...
$_LANG['noPasswordResetWhenLoggedIn'] = "Non è possibile richiedere una reimpostazione della password dopo aver effettuato l'accesso. Uscire prima di iniziare.";

$_LANG['unableToLoadShoppingCart'] = "Impossibile caricare il tuo carrello. Si prega di contattare l'assistenza.";

$_LANG['showMenu'] = "Mostra Menu";
$_LANG['hideMenu'] = "Nascondi Menu";

$_LANG['from'] = "Da";
$_LANG['featuredProduct'] = "Populari";
...
$_LANG['orderForm']['enterPersonalDetails'] = "Inserisci i tuoi dettagli personali e i dati di fatturazione per il checkout.";
...
$_LANG['orderForm']['personalInformation'] = "PInformazioni personali";
$_LANG['orderForm']['firstName'] = "Nome";
$_LANG['orderForm']['lastName'] = "Cognome";
$_LANG['orderForm']['phoneNumber'] = "Telefono";
$_LANG['orderForm']['billingAddress'] = "BIndirizzo fatturazione";
...
$_LANG['orderForm']['domainAlternativeContact'] = "È possibile specificare i dettagli di contatto registrati alternativi per le registrazioni di dominio nel proprio ordine quando si effettua un ordine per conto di un'altra persona o ente. Se non si richiede questo, è possibile saltare questa sezione.";
...
$_LANG['orderForm']['preferredPaymentMethod'] = "Si prega di scegliere il metodo di pagamento preferito.";
$_LANG['orderForm']['cardNumber'] = "Numero carta";
$_LANG['orderForm']['cvv'] = "Codice cvv";
$_LANG['orderForm']['additionalNotes'] = "Note aggiuntive";
$_LANG['orderForm']['continueToClientArea'] = "Continua nel area cliente";
$_LANG['orderForm']['reviewDomainAndAddons'] = "Si prega di rivedere le selezioni del nome di dominio e tutti gli addon che sono disponibili per loro.";
...
$_LANG['orderForm']['registerLongerAndSave'] = "Registrati per più tempo e risparmia!";
$_LANG['orderForm']['tryRegisteringInstead'] = "Prova invece a registrare questo dominio.";
$_LANG['orderForm']['domainAvailabilityCached'] = "I risultati di disponibilità del dominio sono memorizzati nella cache, il che potrebbe portare alla visualizzazione dei domini registrati di recente come disponibili.";
...
$_LANG['orderForm']['estimateTaxes'] = "tasse stimate";
$_LANG['orderForm']['removePromotionCode'] = "Rimuovi codice promozionale";
$_LANG['orderForm']['updateTotals'] = "Aggiorna totele";
...
$_LANG['cloudSlider']['feature01Title'] = "Max Server Uptime";
$_LANG['cloudSlider']['feature01Description'] = "L'uptime del server è fondamentale per tutte le aziende - considera il battito cardiaco come hosting per la tua attività. Server di file e database, e-mail e server Web sono una parte indispensabile della maggior parte dei processi aziendali e i tempi di inattività hanno effetti negativi diretti sulla produttività, sulle vendite, sulla soddisfazione dei dipendenti e dei clienti. Ecco perché garantire la massima operatività del server è così importante per noi: vogliamo essere sicuri che i tuoi processi aziendali stiano andando bene così i tuoi clienti sono felici.";
...
$_LANG['cloudSlider']['feature02Description'] = "I nostri servizi sono gestiti da centinaia di server e data center dislocati in tutto il mondo, quindi puoi stare tranquillo sapendo che i clienti possono accedere al tuo sito web da qualsiasi luogo. Inoltre, forniamo strumenti di monitoraggio per fornirti analisi specialistiche: il traffico del sito Web è un passo importante per migliorare l'efficienza e la popolarità del tuo sito, oltre a tenere traccia di dove arrivano i tuoi visitatori, a che ora del giorno ti stanno visitando e per quanto tempo resteranno. La nostra dedizione a un mercato globale si estende alle registrazioni di domini, in quanto offriamo i TLD più popolari per la registrazione.";
$_LANG['cloudSlider']['feature02DescriptionTwo'] = "La nostra dedizione all'assistenza clienti arriva anche in tutto il mondo. Siamo qui per aiutarti con il tuo hosting in ogni modo possibile, e puoi raggiungerci via telefono, email o live chat.";
$_LANG['cloudSlider']['feature03Title'] = "Massima sicurezza";
$_LANG['cloudSlider']['feature03Description'] = "State tranquilli sapendo che forniamo il monitoraggio della sicurezza 24/7 e la protezione DDoS. Prendi sul serio la protezione dei dati dei tuoi clienti, e anche noi. Il nostro team di sicurezza e le nostre tutele sono sul lavoro tutto il giorno, ogni giorno per fornire il livello di sicurezza necessario nell'era digitale di oggi.";
...
$_LANG['cPanel']['usageStatsBwOverLimit'] = "Hai superato il limite di larghezza di banda.";
$_LANG['cPanel']['usageStatsDiskOverLimit'] = "Hai superato il limite di spazio sul disco.";
$_LANG['insufficientstockmessage'] = "Attualmente siamo a basso stock su determinati articoli. Le quantità del carrello sono state adeguate di conseguenza.";
...
$_LANG['sso']['disablenotice'] = "È possibile disabilitare questa funzionalità se si fornisce l'accesso a una qualsiasi delle applicazioni di terze parti agli utenti che non si desidera poter accedere al proprio account di fatturazione.";
...
$_LANG['oauth']['badTwoFactorAuthModule'] = "Modulo Two Factor Auth errato. Si prega di contattare l'assistenza.";
...
$_LANG['verificationKeyExpired'] = "Questa chiave di verifica dell'e-mail è scaduta. Effettua il login per richiedere una nuova.";
$_LANG['emailAddressVerified'] = "Grazie per aver confermato il tuo indirizzo email.";
$_LANG['emailKeyExpired'] = "Questa chiave di verifica dell'e-mail è scaduta. Si prega di richiedere una nuova.";
...
$_LANG['markdown']['thisIsAQuote'] = "Questa è una quota";
...
$_LANG['oauth']['authoriseAppToAccess'] = "Autorizzi :appName<br />per accedere al tuo account?";
...
$_LANG['oauth']['loginToGrantApp'] = "Accedi a :appName<br />per entrate nel tuo account";
...
$_LANG['orderForm']['suggestedDomains'] = "Sugerimenti domini";
$_LANG['orderForm']['generatingSuggestions'] = "Generando sugetimenti";
...
$_LANG['orderForm']['extendExclusions'] = "Esclusi alcuni TLD e domini recentemente rinnovati";
$_LANG['orderForm']['singleTransfer'] = "Trasferimento singolo dominio";
$_LANG['orderForm']['enterDomain'] = "Inserisci il tuo cominio";
$_LANG['orderForm']['authCode'] = "Codice autorizzazione";
$_LANG['orderForm']['authCodePlaceholder'] = "Epp Code / Auth Code";
$_LANG['orderForm']['authCodeTooltip'] = "Per avviare un trasferimento è necessario ottenere il codice di autorizzazione dal tuo attuale registrar. Questi possono spesso essere indicati come il codice epp o il codice di autenticazione. Fungono da password e sono unici per il nome di dominio.";
$_LANG['orderForm']['help'] = "Aiuto";
$_LANG['orderForm']['required'] = "Richiesto";

$_LANG['orderForm']['checkingAvailability'] = "Controlla disponibilità";
$_LANG['orderForm']['verifyingTransferEligibility'] = "Controllo idoneita trasferimento";
$_LANG['orderForm']['verifyingDomain'] = "Verifico i dominii che hai selezionato";
...
$_LANG['orderForm']['domainInvalidCheckEntry'] = "Si prega di controllare la voce e riprovare.";
...
$_LANG['cartSimpleCaptcha'] = "Si prega di inserire il codice mostrato di seguito";

$_LANG['clientHomePanels']['showingRecent100'] = "Mostrando i 100 record più recenti";
...
$_LANG['pricing']['selectExtCategory'] = "Si prega di scegliere una categoria dall'alto.";
...
$_LANG['store']['ssl']['dv']['descriptionContent'] = "<p>I certificati di convalida del dominio offrono un modo economico e veloce per implementare SSL sul tuo sito web. I certificati convalidati dal dominio verificano che possiedi il dominio, ma non esegui ulteriori convalide a livello di organizzazione/azienda.</p><p>I certificati convalidati dal dominio sono ideali per siti Web personali, blog e social media o qualsiasi sito che non trasmette informazioni private e riservate. Un certificato Convalida dominio attiva il lucchetto del browser e abilita l'uso di https per assicurare ai visitatori del tuo sito Web e ai clienti che prendi sul serio la loro privacy.</p>";

$_LANG['store']['ssl']['ov']['tagline'] = "SSL ad alta sicurezza mostra ai visitatori del sito web la tua identità autenticata";
$_LANG['store']['ssl']['ov']['descriptionTitle'] = "Cos'è SSL per la convalida dell'organizzazione?";
$_LANG['store']['ssl']['ov']['descriptionContent'] = "<p>I certificati SSL convalidati dall'organizzazione forniscono conferma immediata dell'identità e una forte protezione SSL per il tuo sito web e la tua attività.</p><p>OV SSL è un certificato convalidato dall'organizzazione che offre al tuo sito Web una maggiore credibilità rispetto ai certificati SSL convalidati dal dominio. Attiva il lucchetto del browser e https, mostra la tua identità aziendale e assicura ai tuoi clienti che prendi molto sul serio la sicurezza. I visitatori del sito possono verificare che il sito web sia gestito da una società legittima e non sia un sito di impostori.</p>";

$_LANG['store']['ssl']['ev']['tagline'] = "Attiva la barra degli indirizzi verde per la massima fiducia e conversioni";
$_LANG['store']['ssl']['ev']['descriptionTitle'] = "Che cos'è SSL di convalida estesa?";
$_LANG['store']['ssl']['ev']['descriptionContent'] = "<p>EV SSL è un certificato di convalida esteso, la più alta classe di SSL disponibile oggi e dà più credibilità e fiducia al tuo sito web rispetto all'utilizzo di un certificato SSL validato dal dominio o dall'organizzazione.</p><p>Extended Validation SSL attiva la barra degli indirizzi verde e visualizza il nome dell'azienda o dell'organizzazione nella barra degli indirizzi del browser.Questi importanti indicatori di sicurezza visiva consentono ai visitatori di sapere che sono stati fatti ulteriori passi per confermare il sito che stanno visitando, aumentando la fiducia degli utenti nel tuo sito Web e la sua credibilità - ecco perché la maggior parte delle grandi aziende e organizzazioni sceglie i certificati EV.</p>";
...
$_LANG['store']['ssl']['wildcard']['descriptionContent'] = "<p>Wildcard SSL ti consente di proteggere un numero illimitato di sottodomini su un singolo certificato. È un'ottima soluzione per chiunque ospiti o gestisca più siti o pagine presenti nello stesso dominio. Il costo una tantum del certificato ti copre per ulteriori sottodomini che potresti aggiungere in futuro.</p><p>A differenza di un certificato SSL standard che viene rilasciato solo per un singolo nome di dominio completo, ad es. www.yourdomain.com, che significa che può essere utilizzato solo per proteggere il dominio esatto a cui è stato rilasciato, un certificato Wildcard SSL viene rilasciato su * .yourdomain.com, dove l'asterisco rappresenta tutti i possibili sottodomini.</p><p>Wildcard SSL è un'opzione disponibile per i certificati SSL DV e OV.</p>";
...
$_LANG['store']['websiteBuilder']['introduction'] = "Il costruttore di siti Web drag-and-drop di Weebly semplifica la creazione di un sito Web potente e professionale senza alcuna competenza tecnica. Oltre 40 milioni di imprenditori e piccole imprese hanno già utilizzato Weebly per costruire la propria presenza online con un sito Web, un blog o un negozio.";
...
$_LANG['ssl']['retrieveCertificate'] = "Ritrova certificato";
...
$_LANG['remoteAuthn']['connectError'] = "Non siamo riusciti a collegare il tuo account. Si prega di contattare l'amministratore del sistema.";
...
$_LANG['remoteAuthn']['completeRegistrationForm'] = "Si prega di compilare il modulo di registrazione di seguito.";
$_LANG['remoteAuthn']['completeNewAccountForm'] = "Si prega di completare le informazioni del nuovo account.";
...
$_LANG['remoteAuthn']['unlinkDesc'] = "Questo scollega definitivamente l'account.";
...
$_LANG['invoicePaymentSuccessAwaitingNotify'] = "Grazie per aver completato la procedura di pagamento. Siamo in attesa di notifica per confermare il pagamento che hai appena effettuato. Ti invieremo un'email di conferma non appena questa sarà stata ricevuta. ";
...
$_LANG['errorPage']['404']['submitTicket'] = "Contatta il supporto";
...
$_LANG['domainRedemptionPeriodFeeInvoiceItem'] = "Commissione di rinnovo del dominio in Periodo di grazia di redenzione per :domainName";
...
$_LANG['domainRenewal']['expiredDaysAgo'] = "Scaduto :days giorni fà";
...
$_LANG['validation']['accepted'] = "Il :attribute deve essere accetato.";
...
$_LANG['validation']['alpha'] = "Il :attribute puù contenere solo numeri.";
...
$_LANG['validation']['filled'] = "Il campo :attribute è obligatorio.";
...
$_LANG['validation']['required'] = "Il campo :attribute è obligatorio.";
...
$_LANG['maxmind']['manualReview'] = "Il tuo ordine è stato trattenuto per la revisione manuale.<br /><br />Se ritieni di aver ricevuto questo messaggio per errore, accetta le nostre scuse e <a href=\"submitticket.php\">apri un ticket di supporto</a> al nostro Servizio Clienti.  Grazie.";
...
$_LANG['store']['weebly']['cartShortDescription'] = "Aggiungi il drag & drop website builder Weebly al tuo hosting per permetterti di creare un sito Web, un negozio o un blog dall'aspetto fantastico.";
...
$_LANG['domains']['optOutReason'] = "Motivo dell'opt-out (facoltativo)";
...
$_LANG['store']['websiteBuilder']['features']['templatesDescription'] = "Modelli di siti web progettati professionalmente complettamente personalizzabili";
...
$_LANG['store']['websiteBuilder']['pricing']['features']['noAds'] = "Nessuna publicità Weebly";
...
$_LANG['store']['websiteBuilder']['pricing']['features']['checkoutOnWeebly'] = "CAcquisti su Weebly.com";
...
$_LANG['store']['websiteBuilder']['pricing']['features']['tax'] = "Calcolatrice imposte";
...
$_LANG['store']['websiteBuilder']['faq']['q2'] = "Il sito sara ottimizzato per cellulari?";
$_LANG['store']['websiteBuilder']['faq']['q3'] = "Posso aggiongere delle foto nel mio sito?";
...
$_LANG['store']['websiteBuilder']['faq']['a1'] = "Sì, il websitebuilder ti consente di includere funzionalità del blog.";
...
$_LANG['store']['toggleNav'] = "Navigazione Toggle";
$_LANG['store']['websiteBuilder']['upgrade']['title'] = "Aggiornamento Weebly";
$_LANG['store']['websiteBuilder']['upgrade']['required'] = "Aggiornamnto richiesto";
...
$_LANG['store']['websiteBuilder']['upgrade']['submitTicket'] = "Contatta il supporto";
