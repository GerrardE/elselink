...
$_ADMINLANG['automation']['domainExpirySyncFrequency'] = "Domain Expiry Sync Frequency";
$_ADMINLANG['automation']['domainExpirySyncFrequencyInfo'] = "(hours) How often the domain expiry sync will run as part of the cron. 0 will use default value of 4 Hours";
